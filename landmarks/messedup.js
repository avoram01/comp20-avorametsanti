    ...
    request.onreadystatechange = function() {
        if (request.readyState == 4 && request.status == 200) {
            ...
            for (var i = 0; i < locations.landmarks.length; i++) {
                ...
                onClickLandmark(locations.landmarks[i], locations.landmarks[i].properties.Location_Name);
            ...
            for (var i = 0; i < locations.people.length; i++) {
                ...
                onClickPerson(peopleMarkers[i], locations.people[i]._id, locations.people[i].lat, locations.people[i].lng);
...
function onClickPerson(marker, title, lat, lng) {
